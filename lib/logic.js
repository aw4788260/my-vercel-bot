...
function buildCategoryTreeList(allCategories, parentId = null, prefix = '') {
    ...
    const children = allCategories
        // FIXED: Gracefully handle old categories with no parentId field
...
export async function studentBrowseCategories(chatId, messageId, categoryId = null) {
    ...
    const subCategories = allCategories.filter(cat => (cat.parentId || null) === categoryId);
    
    let exams = [];
    if (categoryId) {
        // FIXED: Fetch exams for the current category
