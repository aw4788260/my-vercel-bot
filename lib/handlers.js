...
export async function handleMessage(message) {
    ...
    // Centralized question input handler for all question-adding states
    ...
    // This is a separate state that only accepts one question
    if (userState && isUserAdmin && userState.state === 'awaiting_replacement_question') {
